      ...
      <Transition show={isOpen} as={Fragment}>
        ...
        >
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="fixed inset-0 bg-sparks-900/60 backdrop-filter backdrop-blur-sm backdrop-brightness-10" />
          </Transition.Child>
                            ...
                            {({ active }) => (
                              <div
                                className={`px-4 text-[15px] font-normal capitalize py-2 ${
                                  active
                                    ? "bg-sparks-900 dark:bg-slate-600 dark:bg-opacity-60 text-white"

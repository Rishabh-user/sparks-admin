...
import { openAddModal,
    setFilter,
    setSearch,
    toggleMobileTodoSidebar, } from "../app/todo/store";

import AddTodo from "../app/todo/AddTodo";
import Todos from "../app/todo/Todos";
import { ToastContainer } from "react-toastify";

import EditTodoModal from "../app/todo/EditTodo";

import Topfilter from "../app/todo/Topfilter";

import BottomFilter from "../app/todo/BottomFilter";
import ListLoading from "@/components/skeleton/ListLoading";
import Badge from "@/components/ui/Badge";

import TodoHeader from "../app/todo/TodoHeader";
  ...
  return (
    <>
      ...
      <div className="flex md:space-x-5 app_height overflow-hidden relative rtl:space-x-reverse">
        ...
        {width < breakpoints.lg && mobileTodoSidebar && (
          <div
            className="overlay bg-sparks-900 dark:bg-sparks-900 dark:bg-opacity-60 bg-opacity-60 backdrop-filter
